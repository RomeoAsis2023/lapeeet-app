...
7. `_renderScreen()` - 11 edges
8. `_setState()` - 10 edges
9. `_run()` - 10 edges
10. `_renderActiveRide()` - 9 edges
...
Cohesion: 0.28
Nodes (16): _acceptIncoming(), _attachLocal(), attachMesh(), _attachRemote(), _cleanup(), _closeModal(), endCall(), _handleIncoming() (+8 more)

### Community 9 - "check-p2p.js"
Cohesion: 0.11
Nodes (14): ref_fs, ref_path, ref_vm, fs, path, VL, all, fs (+6 more)
