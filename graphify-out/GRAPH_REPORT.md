...
## Corpus Check
- 32 files · ~47,762 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 183 file(s) not represented in the graph (top: (none) 134, .data 43, .css 5)

## Summary
- 585 nodes · 1064 edges · 31 communities (30 shown, 1 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92b3b57a`
...
### Community 30 - "8. COMPLETE FILE CHANGE MANIFEST — Every file modified or created (NO SKIP)"
Cohesion: 0.50
...
## Knowledge Gaps
- **157 isolated node(s):** `fs`, `vm`, `nodeCrypto`, `src`, `sandbox` (+152 more)
...
- **Why does `Lapeeet — dev_phases.md (master plan, no skips)` connect `db-layer.js` to `app.js`, `map-layer.js`, `build-single.py`, `p2p-layer.js`, `call-layer.js`, `base.js`, `auth-layer.js`?**
