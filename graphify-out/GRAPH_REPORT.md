...
## Corpus Check
- 17 files · ~32,583 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 8 file(s) not represented in the graph (top: .css 5, (none) 2, .psd 1)

## Summary
- 375 nodes · 666 edges · 19 communities
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 46 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ba55d7f`
...
### Community 1 - "app.js"
Cohesion: 0.09
Nodes (45): Phase 6 — `?mode=` Role Deep Links ⬜ NEXT (small, independent), _bindAutocomplete(), _bindCapacityDropdown(), applyFocus(), open(), _bindDataScreen(), _bindEbikeScreen(), _bindMapScreenButtons() (+37 more)
