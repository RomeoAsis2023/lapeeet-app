...
## Corpus Check
- 32 files · ~50,073 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 183 file(s) not represented in the graph (top: (none) 134, .data 43, .css 5)

## Summary
- 598 nodes · 1101 edges · 30 communities (29 shown, 1 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 73 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2509d4d3`
...
6. `init()` - 13 edges
7. `_renderScreen()` - 13 edges
8. `_onP2PEvent()` - 12 edges
9. `_render()` - 12 edges
10. `_run()` - 12 edges
...
### Community 1 - "app.js"
Cohesion: 0.07
Nodes (68): Phase 6 — `?mode=` Role Deep Links ✅ DONE, Phase 9 — Phone Registration Gate + WebAuthn Passkeys ✅ DONE (code; ceremony field test pending), _bindAutocomplete(), _bindCapacityDropdown(), applyFocus(), open(), _bindDataScreen(), _bindEbikeScreen() (+60 more)
...
Cohesion: 0.16
Nodes (26): Phase 11 — Device PIN Fallback ✅ DONE, b64urlDecode(), b64urlEncode(), cborDecode(), item(), read(), uint(), coseToSpki() (+18 more)
...
- **Why does `Phase 9 — Phone Registration Gate + WebAuthn Passkeys ✅ DONE (code; ceremony field test pending)` connect `app.js` to `Lapeeet — dev_phases.md (master plan, no skips)`, `auth-layer.js`?**
